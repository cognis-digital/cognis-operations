#!/usr/bin/env sh
# Universal installer for cognis-operations. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/cognis-operations.git"
echo "Installing cognis-operations ..."
...
echo "Done. Run: cognis-operations --help"
